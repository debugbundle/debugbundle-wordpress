...
final class PluginMetadataTest extends TestCase
{
    public function testReleaseMetadataDeclaresWordPress71Compatibility(): void
    {
        ...
        self::assertStringContainsString('Version:           1.5.0', $plugin);
        self::assertStringContainsString("define('DEBUGBUNDLE_WORDPRESS_VERSION', '1.5.0');", $plugin);
        self::assertStringContainsString("define('DEBUGBUNDLE_WORDPRESS_BROWSER_SDK_VERSION', '2.0.0');", $plugin);
        self::assertStringContainsString('Tested up to: 7.1', $readme);
        self::assertStringContainsString('Stable tag: 1.5.0', $readme);
    }
