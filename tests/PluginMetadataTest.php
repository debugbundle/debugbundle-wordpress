...
final class PluginMetadataTest extends TestCase
{
    public function testReleaseMetadataDeclaresWordPress71Compatibility(): void
    {
        ...
        self::assertStringContainsString('Version:           1.4.5', $plugin);
        self::assertStringContainsString("define('DEBUGBUNDLE_WORDPRESS_VERSION', '1.4.5');", $plugin);
        self::assertStringContainsString("define('DEBUGBUNDLE_WORDPRESS_BROWSER_SDK_VERSION', '1.8.0');", $plugin);
