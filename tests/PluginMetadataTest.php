...
final class PluginMetadataTest extends TestCase
{
    public function testReleaseMetadataDeclaresWordPress71Compatibility(): void
    {
        ...
        self::assertStringContainsString("define('DEBUGBUNDLE_WORDPRESS_VERSION', '2.0.0');", $plugin);
        self::assertStringContainsString("define('DEBUGBUNDLE_WORDPRESS_BROWSER_SDK_VERSION', '3.0.0');", $plugin);
