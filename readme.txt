...
= 2.0.2 =
* Bundle PHP SDK 2.0.1 and Browser SDK 3.0.3 with confirmed HTTP delivery and bounded retry handling. Existing settings, relay and spool behavior are preserved.

= 2.0.1 =
* Bundle Browser SDK 3.0.2 with corrected lifecycle memory bounds, shared send quotas, and retry/flush handling. PHP capture, settings, and relay routes are unchanged.
...
* Existing captures remain compatible with Bundle v1.
...
* Sanitize browser stack URLs while retaining useful source coordinates and keeping project credentials server-side.

= 1.4.2 =

* Refresh the bundled PHP and browser SDKs to their Apache 2.0 releases. The WordPress plugin remains GPL-2.0-or-later.
